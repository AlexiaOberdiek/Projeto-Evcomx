...
# Parâmetros robustos para Random Forest
rf_params = {
    'n_estimators': 200,      # Número de árvores
    'max_depth': 20,          # Profundidade (RF aguenta profundidade maior que XGB)
    'min_samples_leaf': 4,    # Evita overfitting (folhas com poucos dados)
    'max_features': 'sqrt',   # Usa raiz quadrada das features (padrão bom)
    'n_jobs': -1,             # Usa todos os processadores
    'random_state': 42
}

model_unique = RandomForestRegressor(**rf_params)
